...
public class BlocksActivity extends Activity implements AsyncQueryListener, View.OnClickListener {
    ...
    public static final String EXTRA_TIME_START = "net.peterkuterna.android.apps.devoxxsched.extra.TIME_START";
    public static final String EXTRA_TIME_END = "net.peterkuterna.android.apps.devoxxsched.extra.TIME_END";
    ...
    public void onClick(View view) {
        if (view instanceof BlockView) {
            ...
            final String blockTitle = ((BlockView) view).getTitle();
            intent.putExtra(Intent.EXTRA_TITLE, blockTitle);
